...
public class TaskbarController implements RootController.PageAware, RootController.ProfileAware {
    ...
    private void handleClick(ActionEvent e) {
        ...
        switch (b.getId()) {
            ...
            case "galleryButton"   -> onPageRequest.accept("explore");   // gallery icon now opens Explore.fxml
            ...
            case "settingsButton"  -> LOG.info("Settings button clicked (no page wired yet)");
