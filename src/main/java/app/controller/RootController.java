...
public class RootController {
    ...
    private static final Set<String> DATABASE_REFRESH_PAGES = Set.of("explore", "map");
    ...
    public void showPage(String key, Optional<Profile> profile) {
        ...
        maybeRefreshDatabaseConnection(key);
    ...
    private void maybeRefreshDatabaseConnection(String key) {
        if (DATABASE_REFRESH_PAGES.contains(key)) {
            boolean connected = DatabaseConnector.refreshConnection();
            if (!connected) {
                showDatabaseAlert();
            }
        }
